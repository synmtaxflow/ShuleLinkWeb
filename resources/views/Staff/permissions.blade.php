...
<div class="container-fluid mt-3">
    <div class="card page-card">
        <div class="page-header">Permission Requests</div>
        <div class="card-body">
            <div class="alert alert-info">
                This section will allow staff to submit permission requests and track approval status. Implementation is in progress.
            </div>
