...
<div class="content mt-3">
    <div class="card">
        <div class="card-header bg-primary-custom text-white">
            <strong>Resource Report</strong>
        </div>
        <div class="card-body">
            <div class="alert alert-info">
                <i class="fa fa-info-circle"></i> <strong>Coming Soon!</strong><br>
                Resource report functionality will be available here. This section will provide comprehensive reports on all school resources.
            </div>
        </div>
    </div>
</div>
